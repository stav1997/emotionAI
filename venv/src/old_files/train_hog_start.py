...
from pca import pca
path = "C:\\Users\\stav\\Desktop\\test.jpg"
...
for key, value in dir_pickle_dict.items():
    ...
    pickle_in = open(key+'_model_hog.pickle', 'rb')
    ...
    train_data, test_data, train_target, test_target = train_test_split(features, labels, train_size=0.9)

    model_name = OneClassSVM(kernel='linear', gamma=0.0005, nu=0.03)
    ...
    scores = cross_val_score(model_name, features, labels, cv=5, scoring="accuracy")
    # print(scores)
