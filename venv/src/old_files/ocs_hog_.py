...
# models_dict = {'angry': 'angry_OCS_hog_model_.sav', 'disgust': 'disgust_OCS_hog_model_.sav', 'happy': 'happy_OCS_hog_model_.sav', 'natural': 'natural_OCS_hog_model_.sav', 'sad': 'sad_OCS_hog_model_.sav', 'shock': 'shock_OCS_hog_model_.sav'}
