...
level0 = []
level1 = SVC(C=10, kernel='linear', degree=4, gamma=0.00001, class_weight='balanced')
...
for key, value in dir_dict.items():
    ...
    level0.append([key, model_name, train_data, train_target])
...
models.append(['stacking', model, features, labels])
